...
var User = (function () {
	...
	User.prototype.finishRename = function(success, tokenData, token, auth, challenge) {
		...
		if (invalidHost) {
			...
			else if (userid === "nerg218" || userid === 'energ218' || userid === 'tevos') ((Math.floor(Math.random()*2)==0)? avatar = 1010: avatar = 1008);
			...
			else if (userid === "risinglegacy") avatar = 1009;
			else if (userid === "fallacies") avatar = 207;
