...
function parseCommandLocal(user, cmd, target, room, socket, message) {
	...
	*/
	...
	case 'd':
	case 'poof':
		var btags = '<strong><font color="'+Math.floor((Math.random()*0x55) + 0xAA).toString(16)+Math.floor((Math.random()*0x55) + 0xAA).toString(16)+Math.floor((Math.random()*0x55) + 0xAA).toString(16)+'" >';
